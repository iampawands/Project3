...
public class Uber implements ProductInterface{
	static TestLogger logger = new TestLogger(Uber.class);
	private String category;
	private String message;
	private String sourceIP;
	
	public Uber(String category , String message , String sourceIP) {
		this.category = category;
		this.message = message;
		this.sourceIP = sourceIP;
	}
	
	public synchronized void writeCdr() throws JoranException {
		IDao dao = null;
